...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, StepDIR_Pin|StepEN_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOC, PwrEn_Pin, GPIO_PIN_SET);
  /*Configure GPIO pins : StepDIR_Pin StepEN_Pin */
  GPIO_InitStruct.Pin = StepDIR_Pin|StepEN_Pin;
